...
URI: [cenvo:sample_preparation_method_link](https://w3id.org/chemical-exposome/terms/sample_preparation_method_link)
...
| ---  | ---  |
| self | cenvo:sample_preparation_method_link |
| native | cenvo:sample_preparation_method_link |
