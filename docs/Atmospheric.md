...
URI: [cenvo:Atmospheric](https://w3id.org/chemical-exposome/terms/Atmospheric)
...
| ---  | --- | --- | --- |
| [matrix](matrix.md) | 1 [MatrixAtmospheric](MatrixAtmospheric.md) | Sampled matrix | direct |
| [sampling_method](sampling_method.md) | 1 [SamplingMethodAtmospheric](SamplingMethodAtmospheric.md) | Method used to collect the sample | direct |
